...
<?
	$this->Html->css(array('jquery.fancybox', '/Table/css/grid', '/Icons/css/icons', 'the-modal'), array('inline' => false));
...
<style type="text/css">
	.icon-color[class^="icon"] {display: block;}
	.grid .subheader {
	...
	.product-img {max-width: 100px !important;}
</style>
